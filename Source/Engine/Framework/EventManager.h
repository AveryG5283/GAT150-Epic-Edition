...
#define EVENT_SUBSCRIBE(id, function)	minimum::EventManager::Instance().Subscribe(id, this, std::bind(&function, this, std::placeholders::_1));
#define EVENT_UNSUBSCRIBE(id)			minimum::EventManager::Instance().Unsubscribe(id, this);
