...
#define CREATE_CLASS(classname) minimum::Factory::Instance().Create<minimum::classname>(#classname);
#define CREATE_CLASSBASE(classbase, classname) minimum::Factory::Instance().Create<classbase>(classname);
#define INSTANTIATE(classbase, classname) minimum::Factory::Instance().Create<classbase>(classname);
...
namespace minimum
{
	...
	public:
		...
		virtual std::unique_ptr<minimum::Object> Create() = 0; //create object of that type
	};
	...
	{
	public:
		std::unique_ptr<minimum::Object> Create() override
		{
